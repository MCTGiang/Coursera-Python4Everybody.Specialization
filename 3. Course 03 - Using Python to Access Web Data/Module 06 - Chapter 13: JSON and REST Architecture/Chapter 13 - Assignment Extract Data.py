# Extracting Data from JSON: Write a Python program somewhat similar to http://www.py4e.com/code3/json2.py
...
# Actual data: http://py4e-data.dr-chuck.net/comments_2122557.json (Sum ends with 63)
